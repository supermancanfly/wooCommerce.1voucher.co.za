...
<div class="container order_receipt">

    <!-- start: payment_intro -->
    <div class="payment_intro">
        <!-- start: payment-back -->
        <div class="btn payment-back flex" data-animatea="animated fadeInUp">
            <a href="javascript:window.history.back();" class="button button-secondary" target="">
    ...
    <div class="order-details-pay" id="peach_section">
        <!-- start: left-col -->
        <div class="left-col">
            <div class="section">
