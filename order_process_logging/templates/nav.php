<div id="navigation" class="page-nav <?php if (is_page('shop-listing')) {echo 'theme-light-bg';} ?>">
		...
		<div class="secondary-menu">
			...
			<?php } else {  ?>
				...
				<ul id="menu-nav-menu-primary">				
					...
					<li><a  href="<?php echo get_option('home'); ?>/oneforyou-app/">
