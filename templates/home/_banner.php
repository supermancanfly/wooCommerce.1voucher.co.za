<?php
	if( have_rows('banner') ):?>
		...
		<div class="section page-banner home-banner dark-color flex">
			<div class="container flex">
				...
				<div class="banner-main-wrapper">
					<div class="banner-main flex">
						<div class="col left">
							<div class="home-banner slider-for">
								<?php 
						...
						<div class="col right">
							<div class="home-banner slider-nav">
								<?php 
								while ( have_rows('banner') ) : the_row(); 
									...
									<div class="right-slide">
										<?php if (get_sub_field('featured_image')): ?>
											<img src="<?php echo get_sub_field('featured_image'); ?>" alt="">
										<?php endif; ?>
									</div>	
								<?php endwhile; ?>
							</div>
						...
						<div class="col home-slide-nav">
							<div class="banner-nav flex">
								<div class="col">
									<a href="#page-intro" class="hvr-icon-down infinite">
										<img class="hvr-icon" src="<?php bloginfo('stylesheet_directory'); ?>/images/scroll.png" alt="">
										Scroll
									</a>
